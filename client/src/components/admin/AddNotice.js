				    ...
				    <div className="col-md-8 m-auto">
				      ...
				      <form onSubmit={this.handleSubmit} className="row g-3">
				      	...
				      	<div className="col-md-12">
				      		<label htmlFor="email" className="form-label font-weight-bold">Notice Title:</label>
				      		<input 
					          	type="text" 
				        ...
				        <div className="col-md-12">
				      		<label htmlFor="description" className="form-label font-weight-bold">Notice description:</label>
				      		<textarea 
					          	className="form-control form-control-lg col-md-8" 
